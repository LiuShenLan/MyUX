                ...
                case 1:
                   ...
                   MainActivity.writetxt("Received task flag "+task+"\n",true);
                    if(task==0){
                        ...
                        myPointList = getWayPoints(sss);  //得到一个列表
...
//                        execute_waypoint_task(1,myPointList);//start waypoint task
                        showNormalDialog("666");  //加了上面一行,不用点OK了
//                    }else{
...
//
//                MainActivity.writetxt("执行的waypoints索引: "+index+"\n",true);
...
//        };
        ...
        switch (flag) {
            case 0:
                ...
                mission = createWaypointMission(pointList);  //把pointList传进来
            ...
            case 3:
                ...
                if(mission!=null){
                    //暂停执行任务。只能在WaypointMissionState为EXECUTING的时候
...
//                    MainActivity.writetxt("\n进入了4里面的虚拟控制停止",true);
                    ...
                    //恢复暂停的任务。只能在getCurrentState是EXECUTION_PAUSED的时候
...
//        }
        ...
        builder.autoFlightSpeed(1f); //之前是3f
        builder.maxFlightSpeed(3f);  //之前是10f
